...
data class UserProfile(
    val user_id: String, // 與 Supabase Auth user ID 關聯，應該是主鍵或有唯一索引
    val username: String, // 用戶選擇的唯一用戶名
    val display_name: String? = null, // 用於顯示的名稱，可修改
    val avatar_url: String? = null, // 頭像 URL (來自 Supabase Storage)
    val created_at: String? = null // 由數據庫自動生成 (如果列配置如此) - String 或 Instant 類型，取決於你的配置和反序列化設置
